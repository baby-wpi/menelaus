        		...
        		.addGroup(groupLayout.createSequentialGroup()
        			...
        			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(groupLayout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(releasePanel, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
        				.addGroup(groupLayout.createSequentialGroup()
        		...
        		.addGroup(groupLayout.createSequentialGroup()
        			...
        			.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(groupLayout.createSequentialGroup()
        					...
        					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
        						.addComponent(btnEnableReleaseMode)
        						.addComponent(releasePanel, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
        						.addComponent(btnMakePiece)
        						.addComponent(btnMakeHint))
        					.addGap(18)
        					.addComponent(panelBoardView, GroupLayout.PREFERRED_SIZE, 450, GroupLayout.PREFERRED_SIZE)
